...
def test_are():
    ...
    assert_almost_equal(
        adapted_rand_error(im_true, im_test), (0.3333333, 0.5, 1.0)
    )
    assert_almost_equal(
        adapted_rand_error(im_true, im_test, alpha=0), (0, 0.5, 1.0)
    )
    assert_almost_equal(
        adapted_rand_error(im_true, im_test, alpha=1), (0.5, 0.5, 1.0)
    )
